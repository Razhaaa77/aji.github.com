...
>
  ...
  <body>
      ...
      <div class="layout-container">
          ...
          <?php if($this->session->userdata('level')=='Admin'){?>
            <li class="menu-item <?php if($menu=='konfigurasi'){ echo "active"; }?>">
              <a href="<?= site_url('admin/konfigurasi') ?>" class="menu-link">
                ...
                <div data-i18n="Boxicons">Konfigurasi</div>
              </a>
            </li>
            <?php } ?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <!-- Content -->
            <div class = "container-xxl file-grow-1 container-p-y">
              <?= $contents; ?>
            </div>
    ...
    <script>
      $('#ngilang').delay('slow').slideDown('slow').delay(5000).slideUp(600);
    </script>
  </body>
</html>
