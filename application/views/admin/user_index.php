        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td><?= $aa['level'] ?></td>
                    <td>
                        <a href="<?php echo site_url('admin/user/delete_data/'. $aa['id_user']);?>" class="btn btn-sm btn-danger" onClick="return confirm('Apakah anda yakin menghapus')" ><span class="tf-icons bx bx-trash-alt"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Username</label>
                                <input type="text" class="form-control" value="<?= $aa['nama'] ?>" name="username" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
