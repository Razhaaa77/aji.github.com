          ...
          <div class="card">
            ...
            <div class="app-brand justify-content-center">
              ...
              <form class="mb-3" action="<?= base_url('auth/login') ?>" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-secondary d-grid w-100"  style="background-color:black;" type="submit" >Login</button>
                </div>
                <p class="text-center">
                  Don't have an account? <a href="<?= base_url('registrasi') ?>" class="f-w-400">Sign Up</a>
                </p>
                <div id="ngilang">
